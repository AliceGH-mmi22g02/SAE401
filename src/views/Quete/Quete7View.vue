<template>
  <main>
    <h1>Quêtes Quête 7/10</h1>
    <h2> Menaces sur la biodiversité</h2>
    <p>  Les activités humaines, incluant la destruction des habitats, la pollution et le changement climatique réduisent la diversité biologique, essentielle pour l'équilibre écologique et la survie humaine.</p>

<template>
  <main>
    <h1>Quêtes Quête 8/10</h1>
    <h2> Le défi de la gestion des déchets</h2>
    <p>  La production massive de déchets, notamment plastiques, surpasse les capacités de gestion et de recyclage, entraînant la pollution des océans, des sols et contribue à la dégradation des écosystèmes.</p>

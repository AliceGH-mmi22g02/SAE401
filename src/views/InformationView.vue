    ...
    <div v-if="currentQuestionIndex === 0">
      ...
      <div class="grid">
        <div class="grid-forme">
          ...
          <p>- Disparition d'espèces animales et végétales à un rythme alarmant.<br>- Destruction de l'habitat naturel de millions d'êtres vivants.<br>- Fragilisation de l'équilibre des écosystèmes.</p>
        </div>
        ...
        <div class="grid-forme">
          ...
          <p>- Exacerbation du réchauffement climatique.<br> - Destruction des arbres, qui absorbent le carbone et luttent contre l'accumulation de gaz à effet de serre.<br>- Libération de CO2 dans l'atmosphère.<br>- Menace les efforts de conservation</p>
        </div>
        ...
        <div class="grid-forme">
          ...
          <h3>Plantations de palmiers à huile</h3>
          <p>- Dérégulation du débit des rivières.<br>- Augmentation des risques d'inondations et de sécheresses.<br>- Déstabilisation des ressources hydriques.</p>
        </div>
      </div>
    </div>
